...
agent = deepQLearningDoubleDuellingNoisyPERMultistep(stateDim, actionDim, hiddenDim=256, numHiddenLayers=2, numSteps=5, lr=5e-4, tau=0.1, bufferAlpha=0.4, bufferBeta=0.4)
print(agent.critic)
